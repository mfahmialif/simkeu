...
const keteranganLabel = computed(() =>
  isPegawai.value ? "Keterangan" : "Uraian Pengeluaran",
);
...
const onSubmit = async () => {
  ...
  formData.append("nama_kegiatan", rekapNamaKegiatan.value);
    ...
    <VCardText>
      <VForm ref="refForm" @submit.prevent="onSubmit">
        <VRow>
          ...
          <VCol v-if="showDateInForm" cols="12" md="6">
            <AppDateTimePicker
              v-model="tanggal"
              label="Tanggal *"
          ...
          <VCol v-if="typeForm === 'edit' && isPegawai" cols="12" md="6">
            <VAutocomplete
              v-model="pegawaiId"
