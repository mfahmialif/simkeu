...
const props = defineProps({
  ...
  returnPath: {
    type: String,
    default: "/admin/pengeluaran/rumah-tangga",
  },
})
...
const title = ref("Tambah Pengeluaran Rumah Tangga")
...
const menuList = computed(() => [
  ...
  },
  {
    ...
    value: "lihat-data",
    icon: "ri-eye-line",
    clickHandler: () => router.push("/admin/pengeluaran/rumah-tangga"),
  },
])
...
const onSubmit = async () => {
  ...
  const url = editId
    ? `/admin/pengeluaran/rumah-tangga/${editId}`
...
watch(
  ...
  () => {
    if (props.typeForm === "edit" && props.dataForm) {
      title.value = `Update Pengeluaran Rumah Tangga: ${props.dataForm.nama_kegiatan || props.dataForm.tanggal || ""}`
