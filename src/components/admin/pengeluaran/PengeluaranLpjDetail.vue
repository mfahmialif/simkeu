...
const lpjTotal = computed(() => rows.value.reduce((sum, row) => sum + rowTotal(row), 0));
  ...
  >
      ...
      <VCardText>
        <div class="lpj-header">
          <div class="min-w-0">
            ...
            <div v-if="lpj?.sama_dengan_rab" class="text-success text-caption font-weight-medium mt-1">
    ...
    <VCard>
      <VCardItem>
        ...
        <VCardSubtitle>
          {{ loading ? "Memuat data..." : `${rows.length} baris, total ${formatRupiah(lpjTotal)}` }}
        </VCardSubtitle>
      ...
      <VCardText v-else class="pa-0">
        <div
          ...
          class="lpj-row"
        >
          <div class="lpj-row-number">{{ index + 1 }}</div>

          <div class="lpj-row-content">
            <VRow>
              <VCol v-if="isKegiatan" cols="12" md="2">
                <VSelect
              ...
              <VCol v-if="!isKegiatan || isPegawaiKegiatan(row)" cols="12" :md="isKegiatan ? 4 : 5">
                <VAutocomplete
              ...
              <template v-if="isTatapmuka">
                <VCol cols="12" md="2">
                  <VTextField v-model="row.transport_motor" type="number" min="0" label="Transport Motor" />
                </VCol>
                <VCol cols="12" md="2">
                  <VTextField v-model="row.hari_transport_motor" type="number" min="0" label="Hari Motor" />
                </VCol>
                <VCol cols="12" md="2">
                  <VTextField v-model="row.transport_mobil" type="number" min="0" label="Transport Mobil" />
                </VCol>
                <VCol cols="12" md="2">
                  <VTextField v-model="row.hari_transport_mobil" type="number" min="0" label="Hari Mobil" />
                </VCol>
                <VCol cols="12" md="2">
                  <VTextField v-model="row.barokah_mengajar_biasa" type="number" min="0" label="Barokah Mengajar" />
                </VCol>
                <VCol cols="12" md="2">
                  <VTextField v-model="row.jam" type="number" min="0" label="Jam" />
                </VCol>
                <VCol cols="12" md="2">
                  <VTextField v-model="row.barokah_mengajar_double_degree" type="number" min="0" label="Barokah DD" />
                </VCol>
                <VCol cols="12" md="2">
                  <VTextField v-model="row.jam_mengajar_double_degree" type="number" min="0" label="Jam DD" />
                </VCol>
                <VCol cols="12" md="2">
                  <VTextField v-model="row.barokah_uas" type="number" min="0" label="Barokah UAS" />
                </VCol>
                <VCol cols="12" md="2">
                  <VTextField v-model="row.jumlah_mahasiswa_uas" type="number" min="0" label="Mhs UAS" />
                </VCol>
                <VCol cols="12" md="2">
                  <VTextField v-model="row.barokah_sempro" type="number" min="0" label="Barokah Sempro" />
                </VCol>
                <VCol cols="12" md="2">
                  <VTextField v-model="row.jam_sempro" type="number" min="0" label="Jam Sempro" />
                </VCol>
                <VCol cols="12" md="4">
                  <VTextField v-model="row.keterangan_sempro" label="Keterangan Sempro" />
                </VCol>
              </template>

              <template v-if="isKegiatan">
                <VCol cols="12" :md="isPegawaiKegiatan(row) ? 4 : 5">
                  <VTextField v-model="row.nama_kegiatan" label="Nama Kegiatan" />
                </VCol>
                <template v-if="isPegawaiKegiatan(row)">
                  <VCol cols="12" md="2">
                    <VTextField v-model="row.transport" type="number" min="0" label="Transport" />
                  </VCol>
                  <VCol cols="12" md="2">
                    <VTextField v-model="row.barokah" type="number" min="0" label="Barokah" />
                  </VCol>
                </template>
                <VCol v-else cols="12" md="3">
                  <VTextField v-model="row.nominal" type="number" min="0" label="Nominal" />
                </VCol>
              </template>

              <template v-if="isDosenBulanan">
                <VCol cols="12" md="3">
                  <VTextField v-model="row.barokah_dosen_tetap" type="number" min="0" label="Barokah Dosen Tetap" />
                </VCol>
                <VCol cols="12" md="3">
                  <VTextField v-model="row.barokah_struktural" type="number" min="0" label="Barokah Struktural" />
                </VCol>
              </template>

              <template v-if="isStaffBulanan">
                <VCol cols="12" md="2">
                  <VTextField v-model="row.hari" type="number" min="0" label="Hari" />
                </VCol>
                <VCol cols="12" md="3">
                  <VTextField v-model="row.barokah_harian" type="number" min="0" label="Barokah Harian" />
                </VCol>
                <VCol cols="12" md="3">
                  <VTextField v-model="row.barokah_bulanan" type="number" min="0" label="Barokah Bulanan" />
                </VCol>
              </template>
              ...
              <VCol cols="12" md="4">
                <VTextField v-model="row.keterangan" label="Keterangan" />
              </VCol>
          ...
          <div class="lpj-row-actions">
            <VTooltip text="Tambah baris setelah ini" location="top">
