      ...
      >
        ...
        >
          ...
          <VTable density="compact">
            ...
            <tbody>
              <tr
                v-for="(detail, idx) in krsDetails"
                :key="detail.id"
              >
                <td>{{ idx + 1 }}</td>
                <td>
        ...
        >
          ...
          <VCardText>
            ...
            <div class="d-flex gap-3 mb-4 flex-wrap">
              <div
                class="flex-fill rounded-lg pa-3"
                style="background: rgba(var(--v-theme-info), 0.08); min-width: 120px;"
              >
              ...
              <div
                class="flex-fill rounded-lg pa-3"
                style="background: rgba(var(--v-theme-warning), 0.08); min-width: 120px;"
              >
                <p class="text-xs text-medium-emphasis mb-1">
                  Sisa Tagihan
                </p>
              ...
              <div
                class="flex-fill rounded-lg pa-3"
                style="background: rgba(var(--v-theme-primary), 0.06); min-width: 120px;"
              >
                <p class="text-xs text-medium-emphasis mb-1">
                  Sudah Terbayar
                </p>
      ...
      <VCardText class="pa-0">
        ...
        <template v-else>
          ...
          >
            <thead>
              <tr>
                <th class="text-uppercase text-xs">
                  No
                </th>
                <th class="text-uppercase text-xs">
                  Nomor Transaksi
            ...
            <tfoot>
              <tr>
                <td
                  colspan="3"
                  class="text-right font-weight-bold py-3 text-sm"
                >
                  Total Terbayar
                </td>
                <td
                  class="font-weight-bold text-success py-3"
                  colspan="3"
                >
                  {{ formatRupiah(totalTerbayar) }}
                </td>
