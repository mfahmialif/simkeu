...
const angkatan = ref("");
const jenis = ref("");
const jenisDispensasiList = ["Penuh", "Sebagian"];
const tagihan = ref("");
const tagihanList = ["SPP", "UKT", "Lab", "Praktikum"];
const batas = ref("");
...
onMounted(() => {
  ...
  if (props.typeForm === "edit") {
    ...
    jenis.value = props.dataForm.jenis_dispensasi;
    tagihan.value = props.dataForm.tagihan;
...
const onSubmit = async () => {
  ...
  formData.append("jenis_dispensasi", jenis.value);
  formData.append("tagihan", tagihan.value);
