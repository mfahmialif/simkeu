...
const teamData = ref([
  {
    name: 'Samsul Huda, M.Pd',
    position: 'Wakil rektor II Universitas Islam Internasional Darullughah Wadda\'wah',
    image: teamPerson1,
  ...
  {
    name: 'Dr. Musleh Herry, S.H, M.Hum',
    position: 'Kepala Biro Keuangan,Administrasi Umum dan SDM Universitas Islam Internasional Darullughah Wadda\'wah',
    image: teamPerson2,
  ...
  {
    name: 'Husin Ali, M.Pd',
    position: 'Kabag Pengeluaran Anggaran Universitas Islam Internasional Darullughah Wadda\'wah',
    image: teamPerson3,
