  ...
  <div>
    <VCard>
      <VCardItem class="pb-4">
        <VCardTitle>Program Studi</VCardTitle>
      </VCardItem>
      ...
      <VCardText class="d-flex flex-wrap gap-4">
        ...
        <div class="d-flex gap-x-4 align-center" v-if="isAdmin">
          <VBtn
            ...
            @click="$router.push('/admin/setting/prodi/add')"
          >
            Add Data
          </VBtn>
        </div>
            ...
            <VMenu activator="parent">
              <VList>
                <VListItem
                  ...
                  @click="$router.push(`/admin/setting/prodi/edit/${item.id}`)"
                >
                  Edit
                </VListItem>
