...
const deleteDataSubmit = async id => {
  try {
    const response = await $api("/admin/pengeluaran/transportasi/" + id, {
      method: "DELETE",
    })
...
const fetchPetugas = async () => {
  try {
    const items = await fetchPetugasPengeluaranOptions("transportasi")
...
const exportExcel = async () => {
  try {
    ...
    const response = await $api("/admin/pengeluaran/transportasi/export-excel", {
      method: "GET",
      headers: {
        Accept:
    ...
    downloadFileExport(response, "Laporan Pengeluaran Transportasi.xlsx")
    showSnackbar({
...
const exportBsiExcel = async () => {
  try {
    ...
    const response = await $api("/admin/pengeluaran/transportasi/export-bsi", {
      method: "GET",
      headers: {
        Accept:
          "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
    ...
    downloadFileExport(response, "CUZ BSI Pengeluaran Transportasi.xlsx")
    showSnackbar({
...
const exportBsiTxt = async () => {
  try {
    ...
    const response = await $api("/admin/pengeluaran/transportasi/export-bsi-txt", {
      method: "GET",
      headers: {
        Accept: "text/plain",
      },
...
const copyBsiData = async () => {
  try {
    ...
    const response = await $api("/admin/pengeluaran/transportasi/copy-bsi", {
      method: "GET",
      body: {
        search: search.value,
        ...requestFilterPayload.value,
...
onMounted(() => {
  document.title = "Pengeluaran Transportasi - SIMKEU"
  fetchPetugas()
})
</script>
      ...
      <div class="section-heading">
        ...
        <div>
          ...
          <div class="text-body-2 text-medium-emphasis">
            Rekap pengeluaran transportasi.
          </div>
        </div>
      </div>
    ...
    <section class="numbered-section">
      <div class="section-heading">
        ...
        <div>
          ...
          <div class="text-body-2 text-medium-emphasis">
            Detail pengeluaran transportasi.
          </div>
        </div>
      </div>
              ...
              <VMenu activator="parent">
                <VList>
                  <VListItem
                    ...
                    @click="$router.push(`/admin/pengeluaran/transportasi/edit/${item.id}`)"
                  >
                    Edit
                  </VListItem>
