...
const exportBsiExcel = async () => {
  try {
    ...
    const response = await $api("/admin/pengeluaran/sarana-prasarana/export-bsi", {
      method: "GET",
      headers: {
        Accept:
          "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
    ...
    downloadFileExport(response, "CUZ BSI Pengeluaran Sarana Prasarana.xlsx")
    showSnackbar({
...
const exportBsiTxt = async () => {
  try {
    ...
    const response = await $api("/admin/pengeluaran/sarana-prasarana/export-bsi-txt", {
      method: "GET",
      headers: {
        Accept: "text/plain",
      },
...
const copyBsiData = async () => {
  try {
    ...
    const response = await $api("/admin/pengeluaran/sarana-prasarana/copy-bsi", {
      method: "GET",
      body: {
        search: search.value,
        ...requestFilterPayload.value,
