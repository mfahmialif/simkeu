...
const fetchDataForm = async () => {
  ...
  try {
    const { data } = await $api("/admin/pengeluaran/staff-bulanan/" + id, {
      method: "GET",
    });
...
onMounted(() => {
  document.title = "Edit Barokah Staff Bulanan - SIMKEU";
  fetchDataForm();
});
</script>
  ...
  <VRow>
    <VCol cols="12" class="pb-0">
      <VBtn
        ...
        @click="router.push('/admin/pengeluaran/staff-bulanan')"
      >
        Kembali
      </VBtn>
    </VCol>
    ...
    <VCol cols="12">
      ...
      <FormPengeluaranPegawaiBulanan
        ...
        base-path="/admin/pengeluaran/staff-bulanan"
        show-period
      />
    </VCol>
  </VRow>
