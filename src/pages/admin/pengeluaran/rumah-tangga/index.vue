...
const deleteDataSubmit = async id => {
  try {
    const response = await $api("/admin/pengeluaran/rumah-tangga/" + id, {
      method: "DELETE",
    })
...
const fetchPetugas = async () => {
  try {
    const items = await fetchPetugasPengeluaranOptions("rumah_tangga")
...
const exportExcel = async () => {
  try {
    ...
    const response = await $api("/admin/pengeluaran/rumah-tangga/export-excel", {
      method: "GET",
      headers: {
        Accept:
    ...
    downloadFileExport(response, "Laporan Pengeluaran Rumah Tangga.xlsx")
    showSnackbar({
...
onMounted(() => {
  document.title = "Pengeluaran Rumah Tangga - SIMKEU"
  fetchPetugas()
})
</script>
    ...
    <section class="numbered-section">
      <div class="section-heading">
        ...
        <div>
          ...
          <div class="text-body-2 text-medium-emphasis">
            Detail pengeluaran rumah tangga.
          </div>
        </div>
      </div>
      ...
      <VCard>
        <VCardItem class="pb-4">
          <VCardTitle>Pengeluaran Rumah Tangga</VCardTitle>
        </VCardItem>
              ...
              <VMenu activator="parent">
                <VList>
                  <VListItem
                    ...
                    @click="$router.push(`/admin/pengeluaran/rumah-tangga/edit/${item.id}`)"
                  >
                    Edit
                  </VListItem>
