...
const fetchData = async () => {
  try {
    ...
    const response = await $api("/admin/pengeluaran/umum", {
      method: "GET",
      body: {
        page: page.value,
...
const deleteDataSubmit = async id => {
  try {
    const response = await $api("/admin/pengeluaran/umum/" + id, {
      method: "DELETE",
    })
...
const fetchPetugas = async () => {
  try {
    const items = await fetchPetugasPengeluaranOptions("umum")

    petugasList.value = items

    if (!selectedPetugasId.value) {
      selectedPetugasId.value = items.length === 1
...
const exportExcel = async () => {
  try {
    ...
    const response = await $api("/admin/pengeluaran/umum/export-excel", {
      method: "GET",
      headers: {
        Accept:
    ...
    downloadFileExport(response, "Laporan Pengeluaran Umum.xlsx")
    showSnackbar({
...
const exportBsiExcel = async () => {
  try {
    ...
    const response = await $api("/admin/pengeluaran/umum/export-bsi", {
      method: "GET",
      headers: {
        Accept:
          "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
    ...
    downloadFileExport(response, "CUZ BSI Pengeluaran Umum.xlsx")
    showSnackbar({
...
const exportBsiTxt = async () => {
  try {
    ...
    const response = await $api("/admin/pengeluaran/umum/export-bsi-txt", {
      method: "GET",
      headers: {
        Accept: "text/plain",
      },
...
const copyBsiData = async () => {
  try {
    ...
    const response = await $api("/admin/pengeluaran/umum/copy-bsi", {
      method: "GET",
      body: {
        search: search.value,
        ...requestFilterPayload.value,
...
onMounted(() => {
  document.title = "Pengeluaran Umum - SIMKEU"
  fetchPetugas()
})
</script>
  ...
  <div>
    ...
    <section class="numbered-section">
      ...
      <PengeluaranRekapList
        ...
        base-path="/admin/pengeluaran/umum"
        default-expanded
        :allow-release="false"
        enable-excel-export
    ...
    <section class="numbered-section">
      ...
      <VCard>
        <VCardItem class="pb-4">
          <VCardTitle>Pengeluaran Umum</VCardTitle>
        </VCardItem>
        ...
        <VCardText class="d-flex flex-wrap gap-4">
          ...
          <div class="d-flex flex-wrap gap-3 align-center justify-end w-100 w-sm-auto ms-auto">
            ...
            <VBtn
              ...
              @click="$router.push('/admin/pengeluaran/umum/add')"
            >
              Add Data
            </VBtn>
          </div>
        ...
        <VDataTableServer
          ...
          :headers="[
            ...
            { title: 'Nama Pengeluaran', key: 'nama_kegiatan' },
