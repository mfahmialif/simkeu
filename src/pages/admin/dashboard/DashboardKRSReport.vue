  ...
  <VCard>
    ...
    <template v-else>
      ...
      <VCardText>
        ...
        <!-- KRS Progress -->
        <div v-if="!isLoading && totalMahasiswa > 0" class="mt-4">
          ...
          <VTable class="text-no-wrap" density="compact">
            <thead>
              <tr>
                ...
                <th>Tanggal</th>
                <th>SKS</th>
                <th v-if="activeStatusFilter !== 'belum_krs'">Status PA</th>
              </tr>
            </thead>
            <tbody>
              <tr v-if="detailData.length === 0">
                <td :colspan="activeStatusFilter !== 'belum_krs' ? 9 : 8" class="text-center text-disabled py-8">
                  Tidak ada data
                </td>
              </tr>
