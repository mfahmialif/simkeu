...
<template>
  <VCard>
    <VCardItem
      title="Asal Transaksi Keuangan"
      subtitle="Aktivitas penerimaan, pengeluaran, dan piutang"
    >
      <template #append>
        <MoreBtn
          class="mt-n5"
