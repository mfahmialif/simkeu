...
const fetchUsers = async () => {
  try {
    const { data } = await $api("/admin/pemasukan/mahasiswa/piutang", {
      method: "GET",
      body: {
        page: page.value,
      ...
      <VCardText class="d-flex flex-wrap gap-4">
        ...
        <div class="d-flex gap-x-4 align-center">
          ...
          <VBtn
            ...
            @click="$router.push('/admin/pemasukan/mahasiswa/piutang/add')"
          >
            Add Data
          </VBtn>
        </div>
            ...
            <VMenu activator="parent">
              <VList>
                <VListItem
                  ...
                  @click="
                    $router.push(
                      `/admin/pemasukan/mahasiswa/piutang/edit/${item.id}`
                    )
                  "
                >
                  Edit
