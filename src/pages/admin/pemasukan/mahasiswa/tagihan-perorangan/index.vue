  ...
  <div>
    ...
    <VCard>
      <VCardItem class="pb-4">
        <VCardTitle>Tagihan Perorangan</VCardTitle>
      </VCardItem>
      ...
      <VCardText class="d-flex flex-wrap gap-4">
        ...
        <div class="d-flex gap-x-4 align-center flex-wrap">
          ...
          <VBtn
            ...
            @click="
              $router.push('/admin/pemasukan/mahasiswa/tagihan-perorangan/add')
            "
          >
            Add Data
          </VBtn>
            ...
            <VMenu activator="parent">
              <VList>
                <VListItem
                  ...
                  @click="
                    $router.push(
                      `/admin/pemasukan/mahasiswa/tagihan-perorangan/edit/${item.id}`
                    )
                  "
                >
                  Edit
