...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'admin-pengeluaran-dosen-bulanan': RouteRecordInfo<'admin-pengeluaran-dosen-bulanan', '/admin/pengeluaran/dosen-bulanan', Record<never, never>, Record<never, never>>,
    'admin-pengeluaran-dosen-bulanan-add': RouteRecordInfo<'admin-pengeluaran-dosen-bulanan-add', '/admin/pengeluaran/dosen-bulanan/add', Record<never, never>, Record<never, never>>,
    'admin-pengeluaran-dosen-bulanan-edit-id': RouteRecordInfo<'admin-pengeluaran-dosen-bulanan-edit-id', '/admin/pengeluaran/dosen-bulanan/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'admin-pengeluaran-dosen-bulanan-rekap-id': RouteRecordInfo<'admin-pengeluaran-dosen-bulanan-rekap-id', '/admin/pengeluaran/dosen-bulanan/rekap/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    ...
    'admin-pengeluaran-staff-bulanan': RouteRecordInfo<'admin-pengeluaran-staff-bulanan', '/admin/pengeluaran/staff-bulanan', Record<never, never>, Record<never, never>>,
    'admin-pengeluaran-staff-bulanan-add': RouteRecordInfo<'admin-pengeluaran-staff-bulanan-add', '/admin/pengeluaran/staff-bulanan/add', Record<never, never>, Record<never, never>>,
    'admin-pengeluaran-staff-bulanan-edit-id': RouteRecordInfo<'admin-pengeluaran-staff-bulanan-edit-id', '/admin/pengeluaran/staff-bulanan/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'admin-pengeluaran-staff-bulanan-rekap-id': RouteRecordInfo<'admin-pengeluaran-staff-bulanan-rekap-id', '/admin/pengeluaran/staff-bulanan/rekap/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
