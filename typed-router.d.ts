...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'admin-setting-syarat-tagihan': RouteRecordInfo<'admin-setting-syarat-tagihan', '/admin/setting/syarat-tagihan', Record<never, never>, Record<never, never>>,
    'admin-setting-syarat-tagihan-add': RouteRecordInfo<'admin-setting-syarat-tagihan-add', '/admin/setting/syarat-tagihan/add', Record<never, never>, Record<never, never>>,
    'admin-setting-syarat-tagihan-edit-id': RouteRecordInfo<'admin-setting-syarat-tagihan-edit-id', '/admin/setting/syarat-tagihan/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
