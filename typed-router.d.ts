...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'admin-pengeluaran-dosen': RouteRecordInfo<'admin-pengeluaran-dosen', '/admin/pengeluaran/dosen', Record<never, never>, Record<never, never>>,
    'admin-pengeluaran-dosen-add': RouteRecordInfo<'admin-pengeluaran-dosen-add', '/admin/pengeluaran/dosen/add', Record<never, never>, Record<never, never>>,
    'admin-pengeluaran-dosen-edit-id': RouteRecordInfo<'admin-pengeluaran-dosen-edit-id', '/admin/pengeluaran/dosen/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
