...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'admin-pemasukan-pemasukan-tambah': RouteRecordInfo<'admin-pemasukan-pemasukan-tambah', '/admin/pemasukan/pemasukan/tambah', Record<never, never>, Record<never, never>>,
    'admin-pemasukan-pemasukan-tambah-add': RouteRecordInfo<'admin-pemasukan-pemasukan-tambah-add', '/admin/pemasukan/pemasukan/tambah/add', Record<never, never>, Record<never, never>>,
    'admin-pemasukan-pemasukan-tambah-edit-id': RouteRecordInfo<'admin-pemasukan-pemasukan-tambah-edit-id', '/admin/pemasukan/pemasukan/tambah/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    ...
    'admin-saldo-catatan-harian': RouteRecordInfo<'admin-saldo-catatan-harian', '/admin/saldo/catatan-harian', Record<never, never>, Record<never, never>>,
    'admin-saldo-catatan-harian-add': RouteRecordInfo<'admin-saldo-catatan-harian-add', '/admin/saldo/catatan-harian/add', Record<never, never>, Record<never, never>>,
    'admin-saldo-catatan-harian-edit-id': RouteRecordInfo<'admin-saldo-catatan-harian-edit-id', '/admin/saldo/catatan-harian/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
