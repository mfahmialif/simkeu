...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'admin-dashboard-dashboard-krsreport-local': RouteRecordInfo<'admin-dashboard-dashboard-krsreport-local', '/admin/dashboard/DashboardKRSReportLocal', Record<never, never>, Record<never, never>>,
    ...
    'admin-hutang': RouteRecordInfo<'admin-hutang', '/admin/hutang', Record<never, never>, Record<never, never>>,
    ...
    'admin-laporan-pengeluaran-barokah-pegawai': RouteRecordInfo<'admin-laporan-pengeluaran-barokah-pegawai', '/admin/laporan/pengeluaran/barokah-pegawai', Record<never, never>, Record<never, never>>,
    'admin-laporan-pengeluaran-pengeluaran-harian': RouteRecordInfo<'admin-laporan-pengeluaran-pengeluaran-harian', '/admin/laporan/pengeluaran/pengeluaran-harian', Record<never, never>, Record<never, never>>,
    ...
    'admin-pemasukan-mahasiswa-dispensasi-edit-id': RouteRecordInfo<'admin-pemasukan-mahasiswa-dispensasi-edit-id', '/admin/pemasukan/mahasiswa/dispensasi/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'admin-pemasukan-mahasiswa-dispensasi-tagihan': RouteRecordInfo<'admin-pemasukan-mahasiswa-dispensasi-tagihan', '/admin/pemasukan/mahasiswa/dispensasi-tagihan', Record<never, never>, Record<never, never>>,
    'admin-pemasukan-mahasiswa-dispensasi-tagihan-add': RouteRecordInfo<'admin-pemasukan-mahasiswa-dispensasi-tagihan-add', '/admin/pemasukan/mahasiswa/dispensasi-tagihan/add', Record<never, never>, Record<never, never>>,
    'admin-pemasukan-mahasiswa-dispensasi-tagihan-edit-id': RouteRecordInfo<'admin-pemasukan-mahasiswa-dispensasi-tagihan-edit-id', '/admin/pemasukan/mahasiswa/dispensasi-tagihan/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'admin-pemasukan-mahasiswa-laporan': RouteRecordInfo<'admin-pemasukan-mahasiswa-laporan', '/admin/pemasukan/mahasiswa/laporan', Record<never, never>, Record<never, never>>,
    ...
    'admin-pemasukan-mahasiswa-master-jenis-pembayaran-edit-id': RouteRecordInfo<'admin-pemasukan-mahasiswa-master-jenis-pembayaran-edit-id', '/admin/pemasukan/mahasiswa/master/jenis-pembayaran/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    ...
    'admin-pemasukan-mahasiswa-pembayaran-tambahan-edit-id': RouteRecordInfo<'admin-pemasukan-mahasiswa-pembayaran-tambahan-edit-id', '/admin/pemasukan/mahasiswa/pembayaran/tambahan/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'admin-pemasukan-mahasiswa-pengembalian': RouteRecordInfo<'admin-pemasukan-mahasiswa-pengembalian', '/admin/pemasukan/mahasiswa/pengembalian', Record<never, never>, Record<never, never>>,
    ...
    'admin-pemasukan-mahasiswa-semester-pendek': RouteRecordInfo<'admin-pemasukan-mahasiswa-semester-pendek', '/admin/pemasukan/mahasiswa/semester-pendek', Record<never, never>, Record<never, never>>,
    'admin-pemasukan-mahasiswa-semester-pendek-add': RouteRecordInfo<'admin-pemasukan-mahasiswa-semester-pendek-add', '/admin/pemasukan/mahasiswa/semester-pendek/add', Record<never, never>, Record<never, never>>,
    'admin-pemasukan-mahasiswa-semester-pendek-edit-id': RouteRecordInfo<'admin-pemasukan-mahasiswa-semester-pendek-edit-id', '/admin/pemasukan/mahasiswa/semester-pendek/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    ...
    'admin-pemasukan-mahasiswa-tagihan-perorangan': RouteRecordInfo<'admin-pemasukan-mahasiswa-tagihan-perorangan', '/admin/pemasukan/mahasiswa/tagihan-perorangan', Record<never, never>, Record<never, never>>,
    'admin-pemasukan-mahasiswa-tagihan-perorangan-add': RouteRecordInfo<'admin-pemasukan-mahasiswa-tagihan-perorangan-add', '/admin/pemasukan/mahasiswa/tagihan-perorangan/add', Record<never, never>, Record<never, never>>,
    'admin-pemasukan-mahasiswa-tagihan-perorangan-edit-id': RouteRecordInfo<'admin-pemasukan-mahasiswa-tagihan-perorangan-edit-id', '/admin/pemasukan/mahasiswa/tagihan-perorangan/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    ...
    'admin-pengeluaran-absensi-rekap-id': RouteRecordInfo<'admin-pengeluaran-absensi-rekap-id', '/admin/pengeluaran/absensi/rekap/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'admin-pengeluaran-absensi-web-absensi': RouteRecordInfo<'admin-pengeluaran-absensi-web-absensi', '/admin/pengeluaran/absensi/web-absensi', Record<never, never>, Record<never, never>>,
    'admin-pengeluaran-bulanan': RouteRecordInfo<'admin-pengeluaran-bulanan', '/admin/pengeluaran/bulanan', Record<never, never>, Record<never, never>>,
    'admin-pengeluaran-bulanan-add': RouteRecordInfo<'admin-pengeluaran-bulanan-add', '/admin/pengeluaran/bulanan/add', Record<never, never>, Record<never, never>>,
    'admin-pengeluaran-bulanan-edit-id': RouteRecordInfo<'admin-pengeluaran-bulanan-edit-id', '/admin/pengeluaran/bulanan/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'admin-pengeluaran-bulanan-rekap-id': RouteRecordInfo<'admin-pengeluaran-bulanan-rekap-id', '/admin/pengeluaran/bulanan/rekap/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'admin-pengeluaran-dosen-kegiatan': RouteRecordInfo<'admin-pengeluaran-dosen-kegiatan', '/admin/pengeluaran/dosen-kegiatan', Record<never, never>, Record<never, never>>,
    'admin-pengeluaran-dosen-kegiatan-add': RouteRecordInfo<'admin-pengeluaran-dosen-kegiatan-add', '/admin/pengeluaran/dosen-kegiatan/add', Record<never, never>, Record<never, never>>,
    'admin-pengeluaran-dosen-kegiatan-edit-id': RouteRecordInfo<'admin-pengeluaran-dosen-kegiatan-edit-id', '/admin/pengeluaran/dosen-kegiatan/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'admin-pengeluaran-dosen-kegiatan-rekap-id': RouteRecordInfo<'admin-pengeluaran-dosen-kegiatan-rekap-id', '/admin/pengeluaran/dosen-kegiatan/rekap/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'admin-pengeluaran-dosen-tatapmuka': RouteRecordInfo<'admin-pengeluaran-dosen-tatapmuka', '/admin/pengeluaran/dosen-tatapmuka', Record<never, never>, Record<never, never>>,
    'admin-pengeluaran-dosen-tatapmuka-add': RouteRecordInfo<'admin-pengeluaran-dosen-tatapmuka-add', '/admin/pengeluaran/dosen-tatapmuka/add', Record<never, never>, Record<never, never>>,
    'admin-pengeluaran-dosen-tatapmuka-edit-id': RouteRecordInfo<'admin-pengeluaran-dosen-tatapmuka-edit-id', '/admin/pengeluaran/dosen-tatapmuka/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'admin-pengeluaran-dosen-tatapmuka-rekap-id': RouteRecordInfo<'admin-pengeluaran-dosen-tatapmuka-rekap-id', '/admin/pengeluaran/dosen-tatapmuka/rekap/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'admin-pengeluaran-rumah-tangga': RouteRecordInfo<'admin-pengeluaran-rumah-tangga', '/admin/pengeluaran/rumah-tangga', Record<never, never>, Record<never, never>>,
    'admin-pengeluaran-rumah-tangga-add': RouteRecordInfo<'admin-pengeluaran-rumah-tangga-add', '/admin/pengeluaran/rumah-tangga/add', Record<never, never>, Record<never, never>>,
    'admin-pengeluaran-rumah-tangga-edit-id': RouteRecordInfo<'admin-pengeluaran-rumah-tangga-edit-id', '/admin/pengeluaran/rumah-tangga/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'admin-pengeluaran-rumah-tangga-rekap-id': RouteRecordInfo<'admin-pengeluaran-rumah-tangga-rekap-id', '/admin/pengeluaran/rumah-tangga/rekap/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'admin-pengeluaran-sarana-prasarana': RouteRecordInfo<'admin-pengeluaran-sarana-prasarana', '/admin/pengeluaran/sarana-prasarana', Record<never, never>, Record<never, never>>,
    'admin-pengeluaran-sarana-prasarana-add': RouteRecordInfo<'admin-pengeluaran-sarana-prasarana-add', '/admin/pengeluaran/sarana-prasarana/add', Record<never, never>, Record<never, never>>,
    'admin-pengeluaran-sarana-prasarana-edit-id': RouteRecordInfo<'admin-pengeluaran-sarana-prasarana-edit-id', '/admin/pengeluaran/sarana-prasarana/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'admin-pengeluaran-sarana-prasarana-rekap-id': RouteRecordInfo<'admin-pengeluaran-sarana-prasarana-rekap-id', '/admin/pengeluaran/sarana-prasarana/rekap/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'admin-pengeluaran-transportasi': RouteRecordInfo<'admin-pengeluaran-transportasi', '/admin/pengeluaran/transportasi', Record<never, never>, Record<never, never>>,
    'admin-pengeluaran-transportasi-add': RouteRecordInfo<'admin-pengeluaran-transportasi-add', '/admin/pengeluaran/transportasi/add', Record<never, never>, Record<never, never>>,
    ...
    'admin-pengeluaran-umum': RouteRecordInfo<'admin-pengeluaran-umum', '/admin/pengeluaran/umum', Record<never, never>, Record<never, never>>,
    'admin-pengeluaran-umum-add': RouteRecordInfo<'admin-pengeluaran-umum-add', '/admin/pengeluaran/umum/add', Record<never, never>, Record<never, never>>,
    'admin-pengeluaran-umum-edit-id': RouteRecordInfo<'admin-pengeluaran-umum-edit-id', '/admin/pengeluaran/umum/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'admin-pengeluaran-umum-rekap-id': RouteRecordInfo<'admin-pengeluaran-umum-rekap-id', '/admin/pengeluaran/umum/rekap/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'admin-piutang': RouteRecordInfo<'admin-piutang', '/admin/piutang', Record<never, never>, Record<never, never>>,
    'admin-piutang-add': RouteRecordInfo<'admin-piutang-add', '/admin/piutang/add', Record<never, never>, Record<never, never>>,
    'admin-piutang-detail-id': RouteRecordInfo<'admin-piutang-detail-id', '/admin/piutang/detail/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'admin-piutang-edit-id': RouteRecordInfo<'admin-piutang-edit-id', '/admin/piutang/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    ...
    'admin-setting-api': RouteRecordInfo<'admin-setting-api', '/admin/setting/api', Record<never, never>, Record<never, never>>,
    'admin-setting-bsi': RouteRecordInfo<'admin-setting-bsi', '/admin/setting/bsi', Record<never, never>, Record<never, never>>,
    ...
    'admin-setting-mata-uang': RouteRecordInfo<'admin-setting-mata-uang', '/admin/setting/mata-uang', Record<never, never>, Record<never, never>>,
    'admin-setting-mata-uang-add': RouteRecordInfo<'admin-setting-mata-uang-add', '/admin/setting/mata-uang/add', Record<never, never>, Record<never, never>>,
    'admin-setting-mata-uang-edit-id': RouteRecordInfo<'admin-setting-mata-uang-edit-id', '/admin/setting/mata-uang/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'admin-setting-pegawai': RouteRecordInfo<'admin-setting-pegawai', '/admin/setting/pegawai', Record<never, never>, Record<never, never>>,
    ...
    'admin-setting-th-akademik': RouteRecordInfo<'admin-setting-th-akademik', '/admin/setting/th-akademik', Record<never, never>, Record<never, never>>,
    'admin-setting-th-akademik-add': RouteRecordInfo<'admin-setting-th-akademik-add', '/admin/setting/th-akademik/add', Record<never, never>, Record<never, never>>,
    'admin-setting-th-akademik-edit-id': RouteRecordInfo<'admin-setting-th-akademik-edit-id', '/admin/setting/th-akademik/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'admin-user': RouteRecordInfo<'admin-user', '/admin/user', Record<never, never>, Record<never, never>>,
    'admin-user-add': RouteRecordInfo<'admin-user-add', '/admin/user/add', Record<never, never>, Record<never, never>>,
    'admin-user-edit-id': RouteRecordInfo<'admin-user-edit-id', '/admin/user/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
