...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'admin-pengeluaran': RouteRecordInfo<'admin-pengeluaran', '/admin/pengeluaran', Record<never, never>, Record<never, never>>,
    'admin-pengeluaran-add': RouteRecordInfo<'admin-pengeluaran-add', '/admin/pengeluaran/add', Record<never, never>, Record<never, never>>,
    'admin-pengeluaran-edit-id': RouteRecordInfo<'admin-pengeluaran-edit-id', '/admin/pengeluaran/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
