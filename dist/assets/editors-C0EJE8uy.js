import{u as g,S as m,P as f,U as k,a as b}from"./index-CQ96LY21.js";import{T as v,_ as C}from"./TiptapEditor-CpwiriOu.js";import{c,o as d,a as y,d as t,u as o,w as r,v as n,B as a,_ as V,j as x,q as A,b as B,E as w,G as h}from"./vuetify-Dwmbz9tX.js";import{_ as E}from"./rating-DTOSp-lb.js";import"./index-BfLA9FeW.js";const H={class:"border pa-2 rounded"},_={key:0,class:"d-flex flex-wrap gap-x-4 gap-y-2 mb-2"},$={__name:"DemoEditorCustomEditor",setup(u){const i=g({content:`
        <h2>
          Hi there,
        </h2>
        <p>
...
`);return(p,e)=>{const l=C;return d(),c("div",null,[t(l,{modelValue:o(i),"onUpdate:modelValue":e[0]||(e[0]=s=>A(i)?i.value=s:null),class:"border rounded"},null,8,["modelValue"])])}}},T={ts:`<script setup lang="ts">
...
`},D={__name:"editors",setup(u){return(i,p)=>{const e=I,l=E,s=$;return d(),B(w,null,{default:r(()=>[t(h,{cols:"12"},{default:r(()=>[t(l,{title:"Basic Editor",code:o(T)},{default:r(()=>[t(e)]),_:1},8,["code"])]),_:1}),t(h,{cols:"12"},{default:r(()=>[t(l,{title:"Custom Editor",code:o(q)},{default:r(()=>[t(s)]),_:1},8,["code"])]),_:1})]),_:1})}}};export{D as default};
