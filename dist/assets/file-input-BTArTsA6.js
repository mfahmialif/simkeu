import{r as F,w as j,j as r,k as u,u as c,i as V,bn as s,l as i,G as x,N as S,a1 as N,aa as k,P as t,Q as L,p as e,au as p,at as b,H as l}from"./vuetify-52YUcx6A.js";import{_ as d}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{_ as U}from"./AppCardCode-CZglAVp2.js";import"./vue3-perfect-scrollbar-Ch7g35tI.js";import"./index-C6UMdXCe.js";const A={__name:"DemoFileInputLoading",setup(m){const o=F(),n=F(!0);return j(o,()=>{n.value=!o.value[0]}),(_,a)=>(u(),r(s,{modelValue:c(o),"onUpdate:modelValue":a[0]||(a[0]=f=>V(o)?o.value=f:null),loading:c(n),color:"primary",label:"File input"},null,8,["modelValue","loading"]))}},B={__name:"DemoFileInputSelectionSlot",setup(m){const o=F([]);return(n,_)=>(u(),r(s,{modelValue:c(o),"onUpdate:modelValue":_[0]||(_[0]=a=>V(o)?o.value=a:null),multiple:"",placeholder:"Upload your documents",label:"File input","prepend-icon":"ri-attachment-line"},{selection:i(({fileNames:a})=>[(u(!0),x(S,null,N(a,f=>(u(),r(k,{key:f,label:"",size:"small",variant:"outlined",color:"primary",class:"me-2"},{default:i(()=>[t(L(f),1)]),_:2},1024))),128))]),_:1},8,["modelValue"]))}},P={__name:"DemoFileInputValidation",setup(m){const o=[n=>!n||!n.length||n[0].size<1e6||"Avatar size should be less than 1 MB!"];return(n,_)=>(u(),r(s,{rules:o,label:"Avatar",accept:"image/png, image/jpeg, image/bmp",placeholder:"Pick an avatar","prepend-icon":"ri-camera-2-line"}))}},R={};function M(m,o){return u(),r(s,{"show-size":"",label:"File input"})}const T=d(R,[["render",M]]),O={};function Y(m,o){return u(),r(s,{label:"File input","prepend-icon":"ri-camera-line"})}const E=d(O,[["render",Y]]),G={};function H(m,o){return u(),r(s,{multiple:"",label:"File input"})}const Q=d(G,[["render",H]]),W={};function q(m,o){return u(),r(s,{"show-size":"",counter:"",multiple:"",label:"File input"})}const J=d(W,[["render",q]]),K={};function X(m,o){return u(),r(s,{chips:"",label:"File input w/ chips"})}const Z=d(K,[["render",X]]),ee={};function le(m,o){return u(),r(s,{accept:"image/*",label:"File input"})}const te=d(ee,[["render",le]]),ne={};function ie(m,o){return u(),r(b,null,{default:i(()=>[e(p,{cols:"12",sm:"6"},{default:i(()=>[e(s,{label:"Outlined"})]),_:1}),e(p,{cols:"12",sm:"6"},{default:i(()=>[e(s,{label:"Filled",variant:"filled"})]),_:1}),e(p,{cols:"12",sm:"6"},{default:i(()=>[e(s,{label:"Solo",variant:"solo"})]),_:1}),e(p,{cols:"12",sm:"6"},{default:i(()=>[e(s,{label:"Plain",variant:"plain"})]),_:1}),e(p,{cols:"12",sm:"6"},{default:i(()=>[e(s,{label:"Underlined",variant:"underlined"})]),_:1})]),_:1})}const oe=d(ne,[["render",ie]]),ae={};function pe(m,o){return u(),r(s,{label:"File input",density:"compact"})}const se=d(ae,[["render",pe]]),ce={};function ue(m,o){return u(),r(s,{label:"File input"})}const re=d(ce,[["render",ue]]),me={ts:`<template>
  <VFileInput
    accept="image/*"
    label="File input"
  />
