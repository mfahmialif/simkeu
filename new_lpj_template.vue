  ...
  >
    ...
    <div class="lpj-row-content">
      <VRow v-if="isKegiatan">
        ...
        >
          <VSelect
            ...
            label="Kategori"
            :items="[{ title: 'Pegawai', value: 'pegawai' }, { title: 'Non Pegawai', value: 'non_pegawai' }, { title: 'Mahasiswa', value: 'mahasiswa' }]"
            density="compact"
            hide-details
            class="mb-3"
        ...
        >
          <PengeluaranLampiranInput
            ...
            v-model:removed="row.removed_lampiran"
            :existing="row.existing_lampiran"
          />
        </VCol>
      </VRow>
      ...
      <VRow v-else-if="isTatapmuka">
        ...
        >
          <LazyTextField
            v-model="row.jumlah_kegiatan_uas"
            type="number"
            min="0"
            label="Jml UAS"
            density="compact"
        ...
        >
          <LazyTextField
            v-model="row.jumlah_kegiatan_sempro"
            type="number"
            min="0"
            label="Jml Sempro"
            density="compact"
